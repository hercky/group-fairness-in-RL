...
# Reference for XML flags: https://mujoco.readthedocs.io/en/latest/XMLreference.html#geom
...
from envs.mujoco_bots.agent_model import AgentModel


class CustomPointEnv(AgentModel):
    FILE: str = "custom_point.xml"
    ORI_IND: int = 2
