...
class BaseTabularAlgo(object):
    ...
    def update_counts(self, z:int, batch):
        """
    ...
    def collect_trajectories(self,
        ...
        :param env:
        :param z: the sub group
        :param pi: shape [Z, H, S, A] or [Z,S,A]
        :param num_trajs: num of trajectories to collect
        :return:
        """
    ...
    def check_double_experience_collected(self):
        """
        checks if the for any (s,a) pairs, the counts in count_P >= 2 * prev_count_P
